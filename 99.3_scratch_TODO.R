...
#' 4. [X] **Process CEO outputs:** run through data prep scripts to get ref classes.
...
#' 5. [X] **ref_label:**  Pull out of processed CEO data. Can be completed prior
#' to having final maps, but is potential chokepoint linked to processing.    
#' 6. [X] **sample_totals:** Derived from a summary of the collatted CEO data.      
#' 7. [X] **rfcodes:**  Easy-peasy lemon squeezy. Reclass possible, though.  
#' 8. [X] **pixel**  = 30.  
#' 9. [X] **totarea_pix:** Easy to get from total areas.  
#' 10. [X] **Analyze:** Use new functions to rebalance sample and calculate 
