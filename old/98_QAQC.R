...
#'  percentages. We can simply here and use only simple agreement because this
#'  is a derived data set, and we are only interested in the implications of 
#'  the level of agreement that we see between our workers. 
